...
public sealed class VersioningPersistenceTests : IAsyncLifetime
{
    ...
    public void ApplicationModel_ContainsOnlyApprovedFunctionalVersionConsumers()
    {
        ...
        Assert.True(consumers.SetEquals(
            [typeof(ConfigurationRelease), typeof(CalendarDayVersion), typeof(TaskDefinitionVersion), typeof(EligibilityPolicyVersion), typeof(ActivationRuleVersion), typeof(EvidencePolicyVersion), typeof(ValidationPolicyVersion)]));

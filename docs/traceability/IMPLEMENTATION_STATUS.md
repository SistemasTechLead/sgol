...
| Bloqueo diagnóstico vigente | El primer run `35403795801` del SHA `304212b5a7b18f82b3fbddaf2662857369448a7a` mantuvo verdes protección de `Fuentes/`, Gitleaks, build, pruebas, formato, vulnerabilidades, TECH-OPS y sonda `1/1`; el gate HU-035 completó referencia, backup y restore, pero el caso positivo cayó en `reconcile-functional-restore` porque el fixture no había generado la key ring portátil que la primera comprobación de seguridad exige. El primer SHA correctivo `9a8503d417df032b4bab77ee8b7cec0ed9c79a59`, run `35451840507`, fue bloqueado por Gitleaks antes del build debido al literal de contraseña del certificado sintético; se sustituyó por generación efímera sin allowlist ni relajación. La corrección debe superar el gate integral Linux AMD64 sobre un nuevo SHA publicado |

...
| Contratos incorporados | Adenda 44, que inserta `TECH-UI-PLAN-001`; Adenda 45, que inserta `TECH-FRONT-001..005` y `FRONT-001..020`; Adenda 46, aprobada e incorporada localmente como corrección del mapa `BR-N01..BR-N08` y del contrato de sesión/CSRF previo a `TECH-FRONT-003` |
...
| Estado de implementación | `TECH-FRONT-001` `Integrada` mediante PR `#62`, cabeza `7a0d8540dbfd211fc0f5156a02d834c5832bbabf`, check requerido `SUCCESS` run `35906130681`, merge `8c76c094da653903cd72acce9373dd2b0e4a2914`. `TECH-FRONT-002` `Integrada` mediante PR `#63`, cabeza `a464bdac745d6dc38b4e72fe40f5af824287b38a`, pipeline `35912549181` `SUCCESS`, merge `c5313aff32a62118d01e4bde6f139cbfcc1c23f9`. Las cabezas y merges indicados son ancestros de `origin/master`; las tareas posteriores no están iniciadas |
| Punto de parada | La Adenda 46 y `docs/design/navegacion.md` quedaron aprobadas e incorporadas localmente en una rama documental. Esto no equivale a integración en `origin/master` ni autoriza iniciar o reanudar `TECH-FRONT-003`; se requiere una orden explícita posterior sobre una base que contenga la corrección |
...
| `TECH-FRONT-003` | Adendas `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md` y `F07_ADENDA_46_MAPA_DE_NAVEGACION_Y_SESION_FRONTEND.md` | `TECH-FRONT-004` | `No iniciada`; `BR-N01..BR-N08` están resueltas documentalmente por la Adenda 46, cuya integración en la base de implementación y una orden explícita siguen siendo requisitos antes de comenzar |

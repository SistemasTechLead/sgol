...
| `FRONT-010` | Fila 78 de Adenda 45; HU-011/CAP-012, CA/CP-011, CAT-001..008, F06 y Adendas 44/46; extensión BR-D06/UI-C05 y visibilidad de borradores aprobadas durante esta tarea | `origin/master` `f709695291c4ac347065801e9c7164c43396af7c`; rama exclusiva `codex/front-010`; sin commit ni publicación | `Implementada localmente`: catálogo de ocho TAR, detalle/historia, editor cerrado, creación/publicación/desactivación y 412 con recarga explícita en `/configuracion`. Build Release 0 errores/advertencias; unitarias 15/15, PostgreSQL definiciones 7/7 y generación previa 2/2, arquitectura 3/3, `FRONT_BROWSER` completo 13/13, formato dirigido y `git diff --check` aprobados. Contratos, comandos, mapa y capturas sanitizadas en `FRONT_010_DEFINICIONES_TAR.md`. Pipeline remoto y suite integral diferidos; sin commit, push, PR ni merge |

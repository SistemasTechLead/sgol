...
| Publicación e integración | PR `#58` abierto desde `codex/tech-e2e-cv-04`, cabeza previa `f015857bd7786bb70d701795ca11cedc88f2dab1`. La demo integral del run `35529365180` aprobó, pero el attempt 6 falló únicamente al subir artifacts por `Artifact storage quota has been hit`. El responsable autorizó el 2026-09-22 una excepción puntual sin cargos: para PR `#58` se publicarán reportes cerrados y huellas en resumen/log del run, sin omitir gates. Esta vía no conserva el layout OCI descargable ni garantiza los 14 días de los archivos originales; queda visible como desviación de retención de la Adenda 42 y del gate TECH-OPS. Pendientes publicar el commit de esta excepción, comprobar un pipeline verde para su nuevo SHA, revisar la diferencia de retención y obtener autorización explícita de merge. El run `35474478216` había fallado antes por la carrera temporal ya corregida descrita arriba |

...
| Brechas vigentes | BR-D17 y BR-D01 quedaron resueltas por `TECH-FRONT-001`; BR-API11/12 quedaron resueltas para presentación por `TECH-FRONT-002`; `BR-N01..BR-N08` quedaron resueltas documentalmente por la Adenda 46. BR-D02, BR-M01 y BR-M02 quedaron resueltas para `FRONT-001`. El responsable aprobó BR-D03/D15 para `FRONT-002` y su extensión mínima quedó incorporada en `docs/design/componentes.md` y `estados-y-mensajes.md`; BR-D16 se consume con su contrato responsive previamente aprobado. Las demás brechas conservan sólo su tarea consumidora |
| Estado de implementación | `TECH-FRONT-001` `Integrada` mediante PR `#62`, cabeza `7a0d8540dbfd211fc0f5156a02d834c5832bbabf`, check requerido `SUCCESS` run `35906130681`, merge `8c76c094da653903cd72acce9373dd2b0e4a2914`. `TECH-FRONT-002` `Integrada` mediante PR `#63`, cabeza `a464bdac745d6dc38b4e72fe40f5af824287b38a`, pipeline `35912549181` `SUCCESS`, merge `c5313aff32a62118d01e4bde6f139cbfcc1c23f9`. `TECH-FRONT-003` `Integrada` mediante PR `#65`, cabeza `72ded2f86ad7baafa567b34cd3f84dad160ed699`, pipeline `35929424107` `SUCCESS`, merge `35239ebd50e120dd775c07d726df0ca899393b71`. `TECH-FRONT-004` `Integrada` mediante PR `#66`, cabeza `016a7baf6fdba86d449bcf8d5236dee2ac9bd81f`, check requerido `SUCCESS` run `35937796010`, merge `d8fbfff5a87ff39cafd25728ba0b9360fc796cdc`; cabeza y merge ancestros de `origin/master` verificado |
| `FRONT-001` | `Integrada` mediante PR `#67`, cabeza `a1943a8344d4d0b404b8d2d0b30de714a865cf7f`, pipeline `35943670469` `SUCCESS` para esa cabeza y merge `572ce8778b7e4c6860e1d8a32c1737d26df20ba4`; cabeza y merge verificados como ancestros de `origin/master` el 2026-09-24. El run anterior `35942441818` falló y fue sustituido por el run verde de la nueva cabeza. Alcance y pruebas en `docs/traceability/FRONT_001_ACCESO.md` |
| Punto de avance | `FRONT-002` a `FRONT-006` integradas mediante PR `#68` a `#72`, con checks de cabeza exacta y merges verificados como ancestros de `origin/master` en sus filas. `FRONT-007` integrada mediante PR `#73`, check `SUCCESS` run `36160122953` y merge `63a8f7421296c02bf740cf4c462f219fcd3eec5c`. `FRONT-009` integrada mediante PR `#75`, check `SUCCESS` run `36174853716` y merge `9ce0aa82c2494b8826265772d08504bdbd19f5c1`. `FRONT-008` integrada mediante PR `#74`, cabeza `c46552ff776eff1ae1eb84fd4936e9f252fe236f`, check `SUCCESS` run `36183955306` y merge `f709695291c4ac347065801e9c7164c43396af7c`; cabeza y merge ancestros de `origin/master`. `FRONT-010` integrada mediante PR `#76`, cabeza `f37310dce7bd6dd38c62fa161cafd28c2e901832`, `TECH-BASE-003 / PR gates` `SUCCESS` run `36195404037` y merge `2443e121c46238433adffd63bc905f8bfccfee2e`; cabeza y merge ancestros de `origin/master` verificados antes de `FRONT-011`. `FRONT-011` publicada para revisión mediante PR `#77`; `FRONT-012..020` y `TECH-FRONT-005` no iniciadas |
...
| `TECH-FRONT-004` | `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md` | Historias con navegador | `Integrada`: PR `#66` merged, cabeza `016a7baf6fdba86d449bcf8d5236dee2ac9bd81f`, check requerido `TECH-BASE-003 / PR gates` `SUCCESS` en run `35937796010`, merge `d8fbfff5a87ff39cafd25728ba0b9360fc796cdc`; cabeza y merge son ancestros de `origin/master` verificado. Harness Playwright de Kestrel HTTPS y PostgreSQL desechable, cuatro fixtures, Chromium escritorio/WebKit móvil, shell vacío, 401, teclado/foco, landmarks, accesibilidad crítica, capturas enmascaradas y cleanup. Comandos y mapa en `TECH_FRONT_004_HARNESS.md`; smoke enfocado `1/1` y arquitectura afectada `9/9` locales. Los runs `35934604798`, `35935550111` y `35936627022` son historial previo a la corrección; el run `35937796010` acredita la cabeza final. Login visual y suite funcional completa quedan fuera del alcance de esta tarea |
...
| `FRONT-001` | `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md`, Adendas 41 y 46 | `TECH-FRONT-003/004` integradas; BR-D01/D02 y BR-M01/M02 resueltas para esta historia | `Integrada`: UI-A01..A05 usan las rutas hospedadas, preauth, CSRF, cambio obligatorio, enrolamiento TOTP, verificación TOTP/recovery y códigos de visualización única. PR `#67` merged; cabeza `a1943a8344d4d0b404b8d2d0b30de714a865cf7f`, run `35943670469` `SUCCESS` para esa cabeza, merge `572ce8778b7e4c6860e1d8a32c1737d26df20ba4`, cabeza y merge ancestros de `origin/master` verificado. El run fallido `35942441818` corresponde al intento anterior. Mapa y comandos históricos en `FRONT_001_ACCESO.md` |
| `FRONT-002` | `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md`, Adendas 41 y 46 | `FRONT-001` integrada; BR-N01..N08 aprobadas; BR-D03/D15 aprobadas e incorporadas en `docs/design`; BR-D16 consumida | `Integrada`: UI-A06/A07, shell, `/` y `/mi-trabajo` protegido, logout POST/CSRF y avisos seguros. PR `#68` merged; cabeza `67a3a3e464b736b21e77a17f6a48b6572e8f0e64`, job `TECH-BASE-003 / PR gates` `SUCCESS` en run `36029391844` para esa cabeza, merge `2bb3910d082036a454e41d2c6ed6bf065fdad157`; cabeza y merge ancestros de `origin/master` verificado. El run anterior `36027873706` falló sobre `e6f73ea` y fue sustituido. Mapa histórico en `docs/traceability/FRONT_002_SESION_Y_SHELL.md` |
| `FRONT-003` | `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md`; `HU-001`, `CA-001`, `CP-001-P/N`; Adenda 46 y extensión mínima de `docs/design` aprobada por el responsable para esa tarea | `FRONT-002` integrada; `GET/POST /api/v1/people` y `GET /api/v1/people/{id}` existentes | `Integrada`: PR `#69` merged; cabeza `65f3b6bc2a4652f7eb92d167e88b9d079444d702`, check `TECH-BASE-003 / PR gates` `SUCCESS` en run `36041719411`, merge `9dba2ed71841c7df443ea773bd986208928d98d1`; ambos ancestros de `origin/master` verificado. UI-I01 lista, alta y detalle con historial. Build Release `26/26`, PostgreSQL `13/13`, `FRONT_BROWSER` `5/5` y demás pruebas locales descritas en `FRONT_003_PERSONAS.md` permanecen como evidencia histórica previa a publicación, no como estado actual de integración. UI-I02..I07 estaban fuera del alcance de esa tarea |
| `FRONT-004` | Fila 67 de Adenda 45; `HU-001/HU-002`, `CA/CP-001/002`, Adenda 46; extensión mínima de `docs/design/estados-y-mensajes.md` aprobada expresamente para UI-I02 | `FRONT-003` integrada; detalle y cliente común existentes; BR-D04 aplicable | `Integrada`: PR `#70` merged, cabeza `aa23c419df907f032b999eeeef7442b99d291dda`, check `TECH-BASE-003 / PR gates` `SUCCESS` en run `36049553112` para esa cabeza, merge `b291d3ab5dafe651455a5230d2aa7780b875c359`; cabeza y merge son ancestros de `origin/master` verificado el 2026-09-24. UI-I02 edita empleo/puesto/turno, baja y reactiva mediante API real con CSRF, `Idempotency-Key` por intención y `If-Match`; conserva historia y exige recarga explícita ante 412. Build Release, unitarias de personas `8/8`, arquitectura de interfaz `9/9`, PostgreSQL de personas `14/14` y `FRONT_BROWSER` completo `6/6` en `FRONT_004_EMPLEO_Y_VIGENCIA.md` son evidencia histórica local previa a publicación, no el estado actual de integración |
| `FRONT-005` | Fila 68 de Adenda 45; `HU-003`, `CA-003`, `CP-003-P/N`, `RN-004/005`, Adenda 46; extensión mínima de `docs/design/componentes.md` y `estados-y-mensajes.md` aprobada expresamente para UI-I03 | `FRONT-004` integrada mediante PR `#70`; GET/PUT de disponibilidad existentes; cliente y sesión compartidos | `Integrada` mediante PR `#71`: cabeza `b8e537ff9e7692ac1ead8d0f1028c5fc7e8f6213`, `TECH-BASE-003 / PR gates` `SUCCESS` run `36059652548` para esa cabeza y merge `6bb9450314bf2c9cf5119d507ef39800b50ef22b`; cabeza y merge ancestros de `origin/master` verificado el 2026-09-24. UI-I03 consulta rango y administra disponibilidad binaria diaria desde el detalle autorizado, distingue ausencia de `false`, usa CSRF, `Idempotency-Key` y `If-Match` al corregir, exige recarga explícita ante 412/`IF_MATCH_INVALIDO`. La proyección de sesión incorpora `PER-DISPONIBILIDAD-ADMIN` sólo para Dirección; el GET devuelve `meta.count` para el cliente común. Build Release 0 errores/advertencias, unitarias de disponibilidad `17/17`, arquitectura `9/9`, PostgreSQL `11/11` y `FRONT_BROWSER` `7/7` en `FRONT_005_DISPONIBILIDAD.md` son evidencia histórica local previa a publicación, no el estado actual de integración |
| `FRONT-006` | Fila 69 de Adenda 45; `HU-006`, `CA-006`, `CP-006-P/N`; Adendas 46 y 47; extensión mínima de `docs/design/componentes.md` y `estados-y-mensajes.md` aprobada expresamente para UI-I04/I05 | `FRONT-005` integrada mediante PR `#71`; API real `/api/v1/users`, cliente común y sesión request-scoped existentes | `Integrada` mediante PR `#72`: cabeza `aa5f6daaf9fe4e365a19ae555ed21a4b3b5528d3`, run `36072586018` con `TECH-BASE-003 / PR gates` `SUCCESS` para esa cabeza, merge `64b77802afbee2780032b4c020663be7db199474`; cabeza y merge ancestros verificados de `origin/master`. Dirección lista, crea, desactiva y reactiva cuentas individuales con `PER-USUARIO-ADMIN`, CSRF e idempotencia; Adenda 47 autorizó la contraseña temporal de visualización única sólo para alta y reactivación. Build Release, unitarias `8/8`, arquitectura `9/9`, PostgreSQL `10/10` y `FRONT_BROWSER` `8/8` en `FRONT_006_CUENTAS.md` son evidencia local histórica anterior a la publicación, no el estado actual de integración |
| `FRONT-007` | Fila 70 de Adenda 45; `HU-007`/`CAP-007`, `CA-007`/`CP-007-P/N`; F06 y Adendas 41, 46 y 48; extensión de diseño UI-I06/I07 aprobada expresamente | `FRONT-006` integrada mediante PR `#72`; contrato GET de rol e historia, reset con generación única y MFA reciente aprobados para este consumidor | `Integrada` mediante PR `#73`: cabeza `e7a7661bb679b383434fc47f13390fdc773d1012`, run `36160122953` con `TECH-BASE-003 / PR gates` `SUCCESS` para esa cabeza y merge `63a8f7421296c02bf740cf4c462f219fcd3eec5c`; ambos commits ancestros de `origin/master` verificado. La evidencia local de `FRONT_007_ROLES_MFA.md` permanece histórica, no como estado actual de publicación |
| `FRONT-008` | Fila 76 de Adenda 45; `HU-005/009/010`, `CA/CP-005/009/010`, Adenda 49 y extensión UI-C01/C02/C03 de `docs/design` aprobada | PR `#74` integrado, rama exclusiva `codex/front-008`, rebasada sobre el merge `9ce0aa82c2494b8826265772d08504bdbd19f5c1` de FRONT-009 | `Integrada` mediante PR `#74`: cabeza `c46552ff776eff1ae1eb84fd4936e9f252fe236f`, check `TECH-BASE-003 / PR gates` `SUCCESS` run `36183955306` para esa cabeza y merge `f709695291c4ac347065801e9c7164c43396af7c`; cabeza y merge ancestros de `origin/master` verificados el 2026-09-25. Evidencia local histórica: UI-C01 consulta `LOR-001`; UI-C02 consulta la semana ISO; UI-C03 consulta calendario publicado por rango y edita días de una release `BORRADOR` con CSRF, idempotencia, `If-Match`, replay/no efecto y 412 con recarga. El recorrido de primera release usa UI-C04 integrada para crear borrador y vuelve a UI-C03 con su ID real; ambos componentes conviven en `/configuracion` sin exponer controles de Dirección a otros roles. BR-API01 no se implementa porque la Adenda 49 excluye edición de sucursal; la consulta cubre el alcance autorizado. Build Release 0 errores/advertencias, unitarias `41/41`, PostgreSQL `16/16`, arquitectura completa `58/58` y `FRONT_BROWSER` `12/12` locales. El primer run remoto de la rama rebasada falló por el conteo estático 18/19 del consumidor de idempotencia; se reprodujo y corrigió en la misma tarea. El run posterior `36181179417` pasó para su cabeza exacta histórica; el check de la cabeza documental final se verifica externamente antes de solicitar merge. Comandos, mapa y capturas sanitizadas en `FRONT_008_CONFIGURACION_Y_PLANIFICACION.md` |
| `FRONT-009` | Fila 77 de Adenda 45; `HU-008`/`CAP-009`, `CA-008`/`CP-008-P/N`, F06 y Adenda 49; extensión UI-C04 y resolución consumidora BR-M13 aprobadas el 2026-09-25 | Rama `codex/front-009` desde la base `63a8f7421296c02bf740cf4c462f219fcd3eec5c`, sin commits del PR `#74`; excepción de orden aprobada | `Integrada` mediante PR `#75`: cabeza `59c5371e8a4d22c65bfa19f4cd95790e45b58e04`, check `TECH-BASE-003 / PR gates` `SUCCESS` run `36174853716` para esa cabeza y merge `9ce0aa82c2494b8826265772d08504bdbd19f5c1`; cabeza y merge ancestros de `origin/master` verificado el 2026-09-25. UI-C04 en `/configuracion` lista historia, crea borrador y publica con CSRF, idempotencia e `If-Match`; 412 exige recarga explícita. Mapa y pruebas locales previas a publicación en `FRONT_009_RELEASES.md` son evidencia histórica |
| `FRONT-010` | Fila 78 de Adenda 45; HU-011/CAP-012, CA/CP-011, CAT-001..008, F06 y Adendas 44/46; extensión BR-D06/UI-C05 y visibilidad de borradores aprobadas durante esa tarea | PR `#76`, cabeza final `f37310dce7bd6dd38c62fa161cafd28c2e901832`; merge `2443e121c46238433adffd63bc905f8bfccfee2e` | `Integrada`: catálogo de ocho TAR, detalle/historia, editor cerrado, creación/publicación/desactivación y 412 con recarga explícita en `/configuracion`. `TECH-BASE-003 / PR gates` `SUCCESS` run `36195404037` para la cabeza final; PR `MERGED`; cabeza y merge ancestros de `origin/master` `2443e121c46238433adffd63bc905f8bfccfee2e` verificados al iniciar `FRONT-011`. Las pruebas locales anteriores permanecen como evidencia histórica: build Release 0 errores/advertencias; unitarias 15/15, PostgreSQL definiciones 7/7 y generación previa 2/2, arquitectura 3/3, `FRONT_BROWSER` completo 13/13, formato dirigido y `git diff --check`. Contratos, comandos, mapa y capturas sanitizadas en `FRONT_010_DEFINICIONES_TAR.md` |
| `FRONT-011` | Fila 79 de Adenda 45; HU-012/017, CA/CP-012/017, F06, Adendas 44/46 y extensión consumidora BR-API09/UI-C06/C07 aprobada para esta tarea | `FRONT-010` integrada mediante PR `#76`; rama aislada `codex/front-011` desde `origin/master` `2443e121c46238433adffd63bc905f8bfccfee2e` | `Publicada` para revisión mediante PR `#77`: lectura autorizada con ETag, versión vigente e historia de activación y elegibilidad por las ocho TAR; editores cerrados con CSRF, `Idempotency-Key`, `If-Match`, replay y 412 con recarga y decisión explícita en `/configuracion`. La proyección de sesión incluye los dos permisos de Dirección; el servidor conserva autorización, historia, auditoría, concurrencia y no efecto. Evidencia local anterior a publicación: build Release 0 errores/advertencias; unitarias 23/23, PostgreSQL 9/9, arquitectura 4/4 y `FRONT_BROWSER` completo 15/15 con Kestrel HTTPS y PostgreSQL real, formato dirigido y `git diff --check`, detallados en `FRONT_011_POLITICAS_TAR.md`. La cabeza final y su check remoto deben verificarse antes de solicitar autorización de merge; aún no integrada. |
| `FRONT-012..020` | `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md` | Según orden y dependencias de la Adenda 45 | `No iniciadas`; cada brecha bloquea sólo su historia consumidora |

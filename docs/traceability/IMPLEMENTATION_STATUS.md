...
| Estado de implementación | `TECH-FRONT-001` `Integrada` mediante PR `#62`, cabeza `7a0d8540dbfd211fc0f5156a02d834c5832bbabf`, check requerido `SUCCESS` run `35906130681`, merge `8c76c094da653903cd72acce9373dd2b0e4a2914`. `TECH-FRONT-002` `Integrada` mediante PR `#63`, cabeza `a464bdac745d6dc38b4e72fe40f5af824287b38a`, pipeline `35912549181` `SUCCESS`, merge `c5313aff32a62118d01e4bde6f139cbfcc1c23f9`. `TECH-FRONT-003` `Implementada localmente`, sin commit ni publicación; ver su fila y registro de pruebas |
| Punto de parada | `TECH-FRONT-003` fue autorizada e implementada localmente sobre la base con Adenda 46. El siguiente paso de commit, push, PR, pipeline y eventual merge requiere autorización expresa del responsable; no se inicia `FRONT-001` ni `TECH-FRONT-004` en esta tarea |
...
| `TECH-FRONT-003` | Adendas `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md` y `F07_ADENDA_46_MAPA_DE_NAVEGACION_Y_SESION_FRONTEND.md` | `TECH-FRONT-004` | `Implementada localmente` en `codex/tech-front-003`, sin commit: snapshot Razor request-scoped, puente de cookies cerrado, CSRF Razor→API, limpieza de identidad y shell condicionado. Corrección mínima autorizada de `application/problem+json` para los cuatro rechazos de autenticación afectados; regresión original y prueba Kestrel HTTPS/PostgreSQL final `1/1` verdes, unitarias enfocadas `77/77`, arquitectura afectada `9/9`, build Release `25` proyectos sin errores ni advertencias. Registro: `docs/traceability/TECH_FRONT_003_PRUEBAS.md`; causa histórica: `docs/traceability/TECH_FRONT_003_BLOQUEO_401.md`. Suite integral, Playwright y CI remotos diferidos por alcance; no se declara `Publicada`, `Integrada` ni `Terminada` |
| `TECH-FRONT-004..005` | `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md` | Según orden y dependencias de la Adenda 45 | `No iniciadas`; cada tarea requiere que su dependencia anterior esté integrada en `origin/master` |

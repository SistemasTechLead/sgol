...
| Publicación e integración | PR `#58` abierto desde `codex/tech-e2e-cv-04`, cabeza inicial de la excepción `2ffe750db2b1fc54b32018719b22e126f3c95fcd`. La demo integral del run `35529365180` aprobó, pero su attempt 6 falló al subir artifacts por `Artifact storage quota has been hit`. El responsable autorizó el 2026-09-22 una excepción puntual sin cargos: para PR `#58` se publican reportes cerrados y huellas en resumen/log del run, sin omitir gates. El run `35769971272` aprobó demo, publicación sanitizada CV-04, formato, OCI, escaneo, TECH-OPS, réplica y HU-035, pero falló al final porque el publicador operativo exigía un diagnóstico HU-035 opcional; se corrigió esa precondición sin cambiar gates. Esta vía no conserva el layout OCI descargable ni garantiza los 14 días de los archivos originales; queda visible como desviación de retención de la Adenda 42 y del gate TECH-OPS. Pendientes publicar la corrección, comprobar un pipeline verde para su nuevo SHA, revisar la diferencia de retención y obtener autorización explícita de merge. El run `35474478216` había fallado antes por la carrera temporal ya corregida descrita arriba |

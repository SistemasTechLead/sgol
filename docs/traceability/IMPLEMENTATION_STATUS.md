...
| Diagnóstico causal de PUT | Adenda 40 aprobada el 2026-09-18: amplía el artifact existente con categorías cerradas del PUT y clasificaciones sanitizadas de red, dirección anunciada, nodo y capacidad después del fallo y antes de limpieza. No cambia S3, topología, ciclo de vida, imagen, reintentos, timeouts ni matriz; requiere un único run diagnóstico del SHA exacto y no acredita cierre de HU-035 |

...
| FRONT-001 local | `Implementada localmente` en `codex/front-001`, sin commit ni publicación; alcance, pruebas y límites en `docs/traceability/FRONT_001_ACCESO.md` |
| Punto de parada | `FRONT-001` fue ordenada expresamente y sus brechas de diseño y mensajes recibieron aprobación en este chat. Esta etapa deja sus cambios sin commit y no inicia `FRONT-002` ni `TECH-FRONT-005` |
...
| `FRONT-001` | `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md`, Adendas 41 y 46 | `TECH-FRONT-003/004` integradas; BR-D01/D02 y BR-M01/M02 resueltas para esta historia | `Implementada localmente` en `codex/front-001`, sin commit: UI-A01..A05 usan las rutas hospedadas, preauth, CSRF, cambio obligatorio, enrolamiento TOTP, verificación TOTP/recovery y códigos de visualización única. Build Release, Playwright HTTPS/PostgreSQL enfocado, regresión de cookies, arquitectura y controles de servidor enfocados pasaron. Mapa y comandos en `FRONT_001_ACCESO.md`. No publicada ni integrada; `FRONT-002` y `TECH-FRONT-005` no iniciadas |
| `FRONT-002..020` | `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md` | Según orden y dependencias de la Adenda 45 | `No iniciadas`; cada brecha bloquea sólo su historia consumidora |

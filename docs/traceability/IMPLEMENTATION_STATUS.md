...
| Punto de avance | `FRONT-002` integrada mediante PR `#68`; `FRONT-003` integrada mediante PR `#69`, cabeza `65f3b6bc2a4652f7eb92d167e88b9d079444d702`, run `36041719411` con `TECH-BASE-003 / PR gates` `SUCCESS` para ese SHA y merge `9dba2ed71841c7df443ea773bd986208928d98d1`; cabeza y merge verificados como ancestros de `origin/master` el 2026-09-24. `FRONT-004` integrada mediante PR `#70`, cabeza `aa23c419df907f032b999eeeef7442b99d291dda`, run `36049553112` `SUCCESS` para ese SHA y merge `b291d3ab5dafe651455a5230d2aa7780b875c359`; cabeza y merge ancestros de `origin/master` verificado el 2026-09-24. `FRONT-005` implementada localmente en `codex/front-005`; `FRONT-006`, `TECH-FRONT-005` y tareas posteriores no iniciadas |
...
| `FRONT-005` | Fila 68 de Adenda 45; `HU-003`, `CA-003`, `CP-003-P/N`, `RN-004/005`, Adenda 46; extensión mínima de `docs/design/componentes.md` y `estados-y-mensajes.md` aprobada expresamente para UI-I03 | `FRONT-004` integrada mediante PR `#70`; GET/PUT de disponibilidad existentes; cliente y sesión compartidos | `Implementada localmente` en `codex/front-005`: UI-I03 consulta rango y administra disponibilidad binaria diaria desde el detalle autorizado, distingue ausencia de `false`, usa CSRF, `Idempotency-Key` y `If-Match` al corregir, exige recarga explícita ante 412/`IF_MATCH_INVALIDO`. La proyección de sesión incorpora `PER-DISPONIBILIDAD-ADMIN` sólo para Dirección; el GET devuelve `meta.count` para el cliente común. Build Release 0 errores/advertencias, unitarias de disponibilidad `17/17`, arquitectura de interfaz `9/9`, PostgreSQL de disponibilidad `11/11` y `FRONT_BROWSER` completo `7/7` locales. Mapa y límites en `FRONT_005_DISPONIBILIDAD.md`. Sin commit, push, PR ni merge |
| `FRONT-006..020` | `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md` | Según orden y dependencias de la Adenda 45 | `No iniciadas`; cada brecha bloquea sólo su historia consumidora |

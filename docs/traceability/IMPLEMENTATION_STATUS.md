...
| Punto de avance | `FRONT-002` integrada mediante PR `#68`; `FRONT-003` integrada mediante PR `#69`, cabeza `65f3b6bc2a4652f7eb92d167e88b9d079444d702`, run `36041719411` con `TECH-BASE-003 / PR gates` `SUCCESS` para ese SHA y merge `9dba2ed71841c7df443ea773bd986208928d98d1`; cabeza y merge verificados como ancestros de `origin/master` el 2026-09-24. `FRONT-004` integrada mediante PR `#70`, cabeza `aa23c419df907f032b999eeeef7442b99d291dda`, run `36049553112` `SUCCESS` para ese SHA y merge `b291d3ab5dafe651455a5230d2aa7780b875c359`; cabeza y merge ancestros de `origin/master` verificado el 2026-09-24. `FRONT-005` integrada mediante PR `#71`, cabeza `b8e537ff9e7692ac1ead8d0f1028c5fc7e8f6213`, check requerido `SUCCESS` run `36059652548` y merge `6bb9450314bf2c9cf5119d507ef39800b50ef22b`; ambos ancestros de `origin/master` verificado. `FRONT-006` integrada mediante PR `#72`, cabeza `aa5f6daaf9fe4e365a19ae555ed21a4b3b5528d3`, run `36072586018` `SUCCESS` para esa cabeza y merge `64b77802afbee2780032b4c020663be7db199474`; ambos ancestros de `origin/master` verificado el 2026-09-25. `FRONT-007` publicada mediante PR `#73`, sin merge; pipeline del SHA final pendiente de verificación; `FRONT-008`, `TECH-FRONT-005` y tareas posteriores no iniciadas |
...
| `FRONT-010..020` | `F07_ADENDA_45_BACKLOG_FRONTEND_DEFINITIVO.md` | Según orden y dependencias de la Adenda 45 | `No iniciadas`; cada brecha bloquea sólo su historia consumidora |
